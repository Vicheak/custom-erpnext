...
app_logo_url = "/assets/erpnext/images/base-app-logo.svg"
app_home = "/app/home"

add_to_apps_screen = [
	{
		"name": app_name,
		"logo": "/assets/erpnext/images/base-app-logo.svg",
		"title": app_title,
		"route": app_home,
...
doc_events = {
	...
	# self doc_event
    "Sales Invoice": {
        "before_save": "erpnext.custom.sales_invoice.calculate_exchange_grand_total"
    },
    
	"Stock Entry": {
        "before_validate": ["erpnext.custom.stock_entry.set_item_accounts",
                            "erpnext.custom.stock_entry.set_scrap_items_target_warehouse"]
    }
}
